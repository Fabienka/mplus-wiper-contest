...
export function LoginForm({
  ...
  // searchParams sem posílá serverová stránka - je to prostý objekt z URL.
  ...
  return (
    <div className="auth-page">
      ...
      <form className="auth-card" onSubmit={handleSubmit}>
        ...
        {/* Hláška patří nad tlačítko - pod ním ji na telefonu překryje
            klávesnice a člověk netuší, proč se nic neděje. */}
        {failure && (
          <div className="auth-notice">
